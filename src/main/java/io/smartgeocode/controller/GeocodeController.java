...
public class GeocodeController {
    ...
    public ResponseEntity<Map<String, Object>> geocode(@RequestParam String address) {
        ...
        try {
            String nominatimUrl = System.getenv("NOMINATIM_URL") != null ? System.getenv("NOMINATIM_URL") : "https://nominatim.openstreetmap.org";
            ...
            if (results != null && results.length > 0) {
                ...
                response.put("lat", Double.parseDouble((String) place.get("lat")));
                response.put("lng", Double.parseDouble((String) place.get("lon")));
